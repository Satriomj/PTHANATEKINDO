...
<head>
    ...
    <title>Hanatekindo | @yield('title')</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand fixed-top" style="background-color: #016278">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar elevation-4" style="background-color: #016278">
        <a href="#" class="brand-link text-center">
            <div style="color: #ffffff; font-family: 'Roboto', sans-serif">
                @if($kelolaTema && $kelolaTema->logo_image)
                    <img src="{{ asset($kelolaTema->logo_image) }}" alt="Logo Hanatekindo" style="width: 140px; height: auto;">
                @else
                    <img src="{{ asset('assets/img/pthanatekindo.jpg') }}" alt="Logo Hanatekindo" style="width: 140px; height: auto;">
                @endif
            </div>
        </a>
        ...
        <div class="content-wrapper mt-5 pt-3"
            style="background-color: #f4f6f9; min-height: calc(100vh - 60px); overflow: auto; padding-bottom: 60px;">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">{{ Auth::user()->user_fullname }}</a></li>
